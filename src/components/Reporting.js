    ...
    function populateCells() {
        var cell = quantifiers.map(quantifier => (
            <tr style={{
                fontSize: "14px",
                fontWeight: "bold"
            }} key={quantifier + "reportRow"}>
                <td>{quantifier}</td>
                <td style={{ backgroundColor: trueIsGreen(quantifierReport[quantifier].q_reporting) }}>
                    {quantifierReport[quantifier].q_last_reported}</td>
                <td style={{ backgroundColor: trueIsGreen(!quantifierReport[quantifier].q_voltage_low) }}>
                    {quantifierReport[quantifier].q_voltage}</td>
                <td style={{ backgroundColor: trueIsGreen(quantifierReport[quantifier].q_sensor1) }}>
                    {String(quantifierReport[quantifier].q_sensor1)}</td>
                <td style={{ backgroundColor: trueIsGreen(quantifierReport[quantifier].q_sensor2) }}>
                    {String(quantifierReport[quantifier].q_sensor2)}</td>
                <td style={{ backgroundColor: trueIsGreen(quantifierReport[quantifier].q_sensor3) }}>
                    {String(quantifierReport[quantifier].q_sensor3)}</td>
                <td style={{ backgroundColor: trueIsGreen(!quantifierReport[quantifier].q_sensor1_0s) }}>
                    {String(quantifierReport[quantifier].q_sensor1_0s)}</td>
                <td style={{ backgroundColor: trueIsGreen(!quantifierReport[quantifier].q_sensor2_0s) }}>
                    {String(quantifierReport[quantifier].q_sensor2_0s)}</td>
                <td style={{ backgroundColor: trueIsGreen(!quantifierReport[quantifier].q_sensor3_0s) }}>
                    {String(quantifierReport[quantifier].q_sensor3_0s)}</td>
                <td style={{ backgroundColor: trueIsGreen(!quantifierReport[quantifier].q_sensor1_too_small) }}>
                    {String(quantifierReport[quantifier].q_sensor1_too_small)}</td>
                <td style={{ backgroundColor: trueIsGreen(!quantifierReport[quantifier].q_sensor2_too_small) }}>
                    {String(quantifierReport[quantifier].q_sensor2_too_small)}</td>
                <td style={{ backgroundColor: trueIsGreen(!quantifierReport[quantifier].q_sensor3_too_small) }}>
